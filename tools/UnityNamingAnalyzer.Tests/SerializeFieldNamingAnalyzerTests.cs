...
using Verify = Microsoft.CodeAnalysis.CSharp.Testing.CSharpAnalyzerVerifier<
    UnityNamingAnalyzer.SerializeFieldNamingAnalyzer,
...
public class TestClass
{
    private int _health;
        ...
        [Fact]
        public async Task PrivateFieldWithoutUnderscore_UNA0001()
        {
            var test = SerializeFieldAttribute + @"
public class TestClass
{
    private int {|#0:health|};
            ...
            var expected = Verify.Diagnostic("UNA0001")
                .WithLocation(0)
...
public class TestClass
{
    [UnityEngine.SerializeField] private int maxHealth;
        ...
        [Fact]
        public async Task SerializeFieldWithUnderscore_UNA0002()
        {
            var test = SerializeFieldAttribute + @"
public class TestClass
{
    [UnityEngine.SerializeField] private int {|#0:_maxHealth|};
            ...
            var expected = Verify.Diagnostic("UNA0002")
                .WithLocation(0)
