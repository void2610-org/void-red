...
using Verify = Microsoft.CodeAnalysis.CSharp.Testing.CSharpAnalyzerVerifier<
    UnityNamingAnalyzer.MemberOrderAnalyzer,
...
public class TestClass
{
    ...
    private void OnDestroy()
    {
        ...
        [Fact]
        public async Task SerializeFieldAfterConstants_UNA0005()
        {
...
public class TestClass
{
    ...
    [SerializeField] private int {|#0:health|};
            ...
            var expected = Verify.Diagnostic("UNA0005")
                .WithLocation(0)
        ...
        [Fact]
        public async Task PublicPropertyAfterPrivateField_UNA0005()
        {
...
public class TestClass
{
    ...
    public int {|#0:Value|} { get; set; }
        ...
        [Fact]
        public async Task UnityEventFollowedByPrivateMethod_UNA0005()
        {
...
public class TestClass
{
    ...
    private void {|#0:Helper|}()
    {
        ...
        [Fact]
        public async Task CleanupFollowedByUnityEvent_UNA0005()
        {
...
public class TestClass
{
    ...
    private void {|#0:Awake|}()
    {
        ...
        [Fact]
        public async Task ExpressionBodyPublicAfterBlockBodyPublic_UNA0005()
        {
...
public class TestClass
{
    ...
    public int GetValue() => _count;
        ...
        [Fact]
        public async Task ConstructorAfterPublicMethods_UNA0005()
        {
...
public struct TestStruct
{
    ...
    public int GetValue() => _count;
        ...
        [Fact]
        public async Task StructMembers_WrongOrder_UNA0005()
        {
            // 構造体の順序違反
            var test = @"
public struct TestStruct
...
public class TestClass
{
    ...
    public int {|#1:Value|} { get; set; }
            ...
            var expected0 = Verify.Diagnostic("UNA0005")
                .WithLocation(0)
                .WithArguments("_count", "private fields", "Unity events");
            var expected1 = Verify.Diagnostic("UNA0005")
                .WithLocation(1)
