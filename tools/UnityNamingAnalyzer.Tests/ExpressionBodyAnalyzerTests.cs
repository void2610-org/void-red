...
using Verify = Microsoft.CodeAnalysis.CSharp.Testing.CSharpAnalyzerVerifier<
    UnityNamingAnalyzer.ExpressionBodyAnalyzer,
...
namespace UnityNamingAnalyzer.Tests
{
    ...
    {
        [Fact]
        public async Task PublicMethodSingleStatement_UNA0004()
        {
            var test = @"
public class TestClass
{
    public int {|#0:GetValue|}()
    {
        return 42;
            ...
            var expected = Verify.Diagnostic("UNA0004")
                .WithLocation(0)
        ...
        [Fact]
        public async Task PublicVoidMethodSingleStatement_UNA0004()
        {
            var test = @"
public class TestClass
{
