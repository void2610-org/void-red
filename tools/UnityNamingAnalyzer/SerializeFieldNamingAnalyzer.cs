...
namespace UnityNamingAnalyzer
{
    ...
    public sealed class SerializeFieldNamingAnalyzer : DiagnosticAnalyzer
    {
        ...
        public static readonly DiagnosticDescriptor UNA0001 = new DiagnosticDescriptor(
            "UNA0001",
        ...
        public static readonly DiagnosticDescriptor UNA0002 = new DiagnosticDescriptor(
            "UNA0002",
        ...
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics =>
            ImmutableArray.Create(UNA0001, UNA0002);
            ...
            if (hasSerializeField)
            {
                ...
                if (startsWithUnderscore)
                {
                    context.ReportDiagnostic(
                        Diagnostic.Create(UNA0002, field.Locations[0], field.Name));
                }
            }
            else
            {
                ...
                {
                    context.ReportDiagnostic(
                        Diagnostic.Create(UNA0001, field.Locations[0], field.Name));
                }
            }
        }
    }
